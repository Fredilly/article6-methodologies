...
const validateRulesRich = require(path.join(repoRoot, 'scripts', 'validators', 'rules.rich.cjs'));
...
function assertRulesRichCoverageContract() {
  ...
  assert.strictEqual(validateRulesRich(rulesRich), true, JSON.stringify(validateRulesRich.errors, null, 2));
